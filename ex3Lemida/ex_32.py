...
def bprop(fprop_cache, y):
  ...
  # y = y+1
  # c_y[y-1] = 1
  # c_y = c_y.reshape((10, 1))
  dz2 = (h2 - c_y)                                #  dL/dz2
  dW2 = np.dot(dz2, h1.T)                       #  dL/dz2 * dz2/dw2
  db2 = dz2                                     #  dL/dz2 * dz2/db2
  dz1 = np.dot(fprop_cache['w2'].T,
    (h2 - c_y)) * sigmoid(z1) * (1-sigmoid(z1))   #  dL/dz2 * dz2/dh1 * dh1/dz1
...
def main():
    ...
    x_train = x_train_all[:50000] / 255
    y_train_all = np.loadtxt(train_y).astype(int)
    y_train = y_train_all[:50000]

    x_test = x_train_all[50000:55000] / 255
    y_test = y_train_all[50000:55000]
